...
public open class Environment2DRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Environment2D>("res://src/main/kotlin/com/example/game/environment/Environment2D.kt", "godot.Node2D", Environment2D::class, false, "Node2D", "") {
        ...
        function(Environment2D::resetTimer, NIL, KtFunctionArgument(NIL, "kotlin.Unit"), DISABLED.id.toInt())
