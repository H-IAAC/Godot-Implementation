...
public open class Player2DRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Player2D>("res://src/main/kotlin/com/example/game/environment/Player2D.kt", "godot.KinematicBody2D", Player2D::class, false, "KinematicBody2D", "") {
        ...
        function(Player2D::getApplesInVision, OBJECT, KtFunctionArgument(OBJECT, "kotlin.collections.ArrayList"), DISABLED.id.toInt())
        function(Player2D::getApplesInTouch, OBJECT, KtFunctionArgument(OBJECT, "kotlin.collections.ArrayList"), DISABLED.id.toInt())
