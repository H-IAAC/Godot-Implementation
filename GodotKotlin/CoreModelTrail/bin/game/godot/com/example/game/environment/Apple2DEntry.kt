...
public open class Apple2DRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Apple2D>("res://src/main/kotlin/com/example/game/environment/Apple2D.kt", "godot.KinematicBody2D", Apple2D::class, false, "KinematicBody2D", "com_example_game_environment_Apple2D") {
