...
public class FroggerMinimalistFE extends FroggerFE {

    public FroggerMinimalistFE(Double xLen, Double yLen, Integer numMaxSteps ) {
    ...
    public LinkedHashMap<String, Double> getFeatures(State state, Action action, Integer currStep, Boolean isDone, Boolean hasWon ) {
        ...
        // previous position (pos of received State).
